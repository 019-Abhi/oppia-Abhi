...
describe('Settings Tab Component', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(
      ...
      Promise.resolve(userPermissions as ExplorationPermissions)
    );
    spyOn(
      userExplorationPermissionsService,
    ...
    spyOnProperty(
      userExplorationPermissionsService,
      'onUserExplorationPermissionsFetched'
  ...
  it('should not create new category if it is not selected', fakeAsync(() => {
  ...
  it('should be able to create new category if it is selected', fakeAsync(() => {
    spyOn(explorationCategoryService, 'saveDisplayedValue').and.stub();
  ...
  it('should get explore page url based on the exploration id', () => {
    ...
    expect(component.getExplorePageUrl()).toBe(
      'https://oppia.org/explore/exp1'
    );
  });
  ...
  it('should delete exploration when closing delete exploration modal', fakeAsync(() => {
    spyOn(
      editableExplorationBackendApiService,
  ...
  it('should remove role when resolving remove-role-modal', fakeAsync(() => {
    ...
    expect(explorationRightsService.removeRoleAsync).toHaveBeenCalled();
  }));
  ...
  it('should open a modal when reassignRole is called', fakeAsync(() => {
    ...
    spyOn(explorationRightsService, 'checkUserAlreadyHasRoles').and.returnValue(
      true
    );
  ...
  it(
    'should transfer exploration ownership when closing transfer ownership' +
      ' modal',
    fakeAsync(() => {
  ...
  it('should toggle notifications', () => {
    ...
    expect(feedbackNotificationsSpy).toHaveBeenCalled();

    component.unmuteFeedbackNotifications();
    expect(feedbackNotificationsSpy).toHaveBeenCalled();

    component.muteSuggestionNotifications();
    expect(suggestionNotificationsSpy).toHaveBeenCalled();
  ...
  it(
    'should check edit-modal has been open ' +
      'when editRole function has been called',
    fakeAsync(() => {
      spyOn(ngbModal, 'open').and.returnValue({
        componentInstance: NgbModalRef,
        result: Promise.resolve(),
  ...
  it('should enable save button when tile and username are valid', () => {
    ...
    explorationTitleService.init('Exploration title');
    component.saveExplorationTitle();
    spyOn(explorationRightsService, 'getOldRole').and.returnValue('editor');
  ...
  it(
    'should get the last edited version number for the ' +
  ...
  it('should fetch the version history data from the backend', fakeAsync(() => {
  ...
  it('should fetch show validation error if the backend api fails', fakeAsync(() => {
    spyOn(
      versionHistoryBackendApiService,
      'fetchMetadataVersionHistoryAsync'
    ).and.resolveTo(null);
  ...
  it(
    'should open the metadata version history modal on clicking the explore ' +
